...
const Projects = () => {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto w-full px-8 md:px-16 mb-12 flex flex-col md:flex-row md:items-end md:justify-between justify-start items-start gap-8">
        {/* The Heavy Header */}
        ...
        <div className="flex gap-4 z-20 self-end">
          <button
