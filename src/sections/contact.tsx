...
const Contact = () => {
  return (
    <section
      id="contact"
      className="w-full h-dvh snap-start flex flex-col justify-center px-8 md:px-16 py-20 bg-background-light text-primary-light dark:bg-background-dark dark:text-primary-dark"
    >
