...
const Contact = () => {
  return (
    <section
      id="contact"
      className="w-full h-dvh snap-start flex flex-col justify-center px-8 pt-8 bg-background-light text-primary-light dark:bg-background-dark dark:text-primary-dark"
    >
